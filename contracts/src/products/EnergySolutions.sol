...
/// @title EnergySolutions — Heating/Cooling Degree Day Insurance
...
contract EnergySolutions {
    ...
    function purchasePolicy(
        ...
        bytes32 policyId = keccak256(
            abi.encodePacked(_targetGrid, msg.sender, block.timestamp, _nonce++)
        );
    ...
    function executeClaim(bytes32 _id, uint256 _actualIndex) external {
        ...
        if (_actualIndex > pol.strikeIndex) {
            ...
            if (payout > pol.maxPayout) payout = pol.maxPayout;

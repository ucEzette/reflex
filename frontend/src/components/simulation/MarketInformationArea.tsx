...
export function MarketInformationArea({ market }: { market: MarketDetail }) {
    return (
        <div className="flex flex-col gap-6 mt-8">
            ...
            <div className="bg-black/[0.03] border border-black/[0.06] rounded-2xl p-6 lg:p-8 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                <div className="bg-black/40 border border-black/[0.04] rounded-xl p-4 flex flex-col items-center text-center justify-center">

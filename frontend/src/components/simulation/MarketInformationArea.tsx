        ...
        <div className="flex flex-col gap-6 mt-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                <div className="bg-black/40 border border-white/5 rounded-xl p-4 flex flex-col items-center text-center justify-center">
                    ...
                    <span className="text-sm font-bold text-white max-w-[120px] truncate">{market.marketData.oracleNode}</span>
                </div>
                <div className="bg-black/40 border border-white/5 rounded-xl p-4 flex flex-col items-center text-center justify-center">
                    <span className="text-xs text-slate-500 uppercase tracking-widest mb-1">Source</span>
                    <span className="text-sm font-bold text-white max-w-[120px] truncate">{market.marketData.resolutionSource}</span>
                </div>
                <div className="bg-black/40 border border-white/5 rounded-xl p-4 flex flex-col items-center text-center justify-center">

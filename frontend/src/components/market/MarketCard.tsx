...
import { Shield, ArrowRight, Activity, Zap, Globe, Plane } from 'lucide-react';
    ...
    return (
        <div className="parent live-market group">
            <div className={`card-3d !h-[420px] bg-gradient-to-br border-white/5`}>
                <div className="glass !inset-0 !rounded-3xl border border-white/10 flex flex-col p-8 justify-between relative overflow-hidden">
                    {/* Background Decorative Element */}
                    <div className="absolute -right-8 -top-8 w-32 h-32 bg-primary/20 blur-3xl rounded-full group-hover:bg-primary/40 transition-all duration-500" />
                    ...
                    <div>
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="text-right">
                                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 block mb-1">Max Payout</span>
                                <span className="text-xl font-bold text-foreground">{product.marketData.maxPayout}</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 text-xs text-slate-400 p-2 rounded-lg bg-white/5 border border-transparent group-hover:border-white/5 transition-all">
                    ...
                    <div className="mt-8">
                        <Link
                            href={product.id === 'flight' ? '/market/flight' : `/market?id=${product.id}`}
                        ...
                        >
                            <button className="dexter-btn !w-full !min-h-[50px] !rounded-xl" type="button">
                                ...
                                <span className="dexter-btn-text flex items-center justify-center gap-2 w-full">
                                    Activate Protection <ArrowRight className="w-4 h-4" />
                                </span>

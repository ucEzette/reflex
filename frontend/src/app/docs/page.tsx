                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-9 space-y-28 pb-20">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 border-t border-white/5 pt-10">
                                    <div className="space-y-5">
                                        ...
                                        {[
                                            ...
                                            { n: "02", title: "Market Premiums", desc: "Earn risk premiums generated by real-world policy purchases." },
                            ...
                            <div className="glass-panel p-8 rounded-2xl space-y-12">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className="text-xl font-bold text-foreground">Arbitrum Sepolia Ecosystem</h3>
                                    </div>
                                    <p className="text-slate-400 font-light leading-relaxed text-sm">
                                        Reflex is natively built for the <strong>Arbitrum Sepolia Network</strong>. We utilize <strong>Arbitrum native messaging</strong> for cross-chain communication and <strong>Arbitrum Sepolia</strong> for our primary testnet deployment, leveraging the network's sub-second finality for rapid parametric settlement.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-4 pt-10 border-t border-white/5">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className="text-xl font-bold text-foreground">Isolated Reserve Vaults</h3>
                                    </div>
                                    <p className="text-slate-400 font-light leading-relaxed text-sm">
                                        Reflex Liquidity Pools are designed to be 100% physically backed. Idle USDT in the pools is secured within smart contract vaults, ensuring that capital is always available for payout settlement without secondary DeFi market risk.
                                    </p>
                                </div>
                            </div>
                        </section>
                                    ...
                                    <div className="relative flex flex-col items-center gap-12 z-10">
                                        ...
                                        <div className="flex flex-col md:flex-row items-center gap-6 w-full max-w-2xl group">
                                            ...
                                            <div className="flex-1 text-center md:text-left">
                                                ...
                                                <p className="text-[10px] text-slate-500">Relayer polls Meteorological/Aviation oracles (NOAA, FlightAware) for sudden risk shifts.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col md:flex-row items-center gap-6 w-full max-w-2xl group">
                                            ...
                                            <div className="flex-1 text-center md:text-left border-l-2 border-amber-500/30 pl-4 py-1">
                                                ...
                                                <p className="text-[10px] text-slate-400 leading-relaxed font-medium">
                                                    The Agent utilizes the <strong>Tether Wallet Development Kit (WDK)</strong> to securely sign transactions. Unlike traditional bots, the agent manages its own self-custodial EVM wallet, broadcasting instructions directly to Arbitrum Sepolia.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col md:flex-row items-center gap-6 w-full max-w-2xl group">
                                            ...
                                            <div className="flex-1 text-center md:text-left">
                                                ...
                                                <p className="text-[10px] text-slate-500">Arbitrum Sepolia executes on-chain actions: <code className="text-emerald-400">underwriteRisk()</code> or <code className="text-emerald-400">updateProtocolMargin()</code>.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-[11px] text-slate-400 leading-relaxed font-light">
                                            By integrating the <code className="text-amber-400 text-[10px]">@tetherto/wdk-wallet-evm</code>, our agent operates outside of centralized relayers. It holds its own keys, manages gas, and executes logic as a first-class participant in the Arbitrum Sepolia ecosystem.
                                        </p>
                                    </div>
                                    <div className="space-y-3">
                                        <h4 className="text-foreground font-bold text-sm flex items-center gap-2">
                        ...
                        <section id="lp-tokenomics" className="scroll-mt-32">
                            ...
                            <div className="glass-panel p-8 rounded-2xl space-y-6">
                                <p className="text-foreground font-light leading-relaxed">
                                    LP shares follow an <strong>ERC-4626-style vault model</strong>. Shares represent a proportional claim on the pool&apos;s total assets (local USDT balance).
                                </p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-[10px] text-slate-500 leading-relaxed line-clamp-4">
                                                Developed in <strong>Solidity 0.8.24</strong> using <strong>Foundry</strong>. We utilize <strong>OpenZeppelin's UUPS</strong> standards for upgradability and secure, capital-efficient vaults based on isolated liquidity models.
                                            </p>
                                        </div>
                                        <div className="space-y-2">
                                            <h4 className="text-amber-400 font-bold text-xs uppercase tracking-widest">Relayer (The Orchestrator)</h4>
                                            <p className="text-[10px] text-slate-500 leading-relaxed line-clamp-4">
                                                A high-speed <strong>Node.js</strong> service that manages EIP-712 quote signing, API proxying, and cross-chain CCIP monitoring. It bridges the gap between Web2 data and Web3 execution.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section id="contracts" className="scroll-mt-32">
                            ...
                            <div className="glass-panel p-8 rounded-2xl space-y-12">
                                <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold mb-8">Arbitrum Sepolia Testnet (Chain ID: 421614)</p>
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        {[
                                            { 
                                                ...
                                                addr: "0x69Cb9508033578358046d0E071a299b2faDA7AE0",
                                                desc: "The primary micro-insurance engine and policy vault. Manages policy issuance, handles parametric triggers via Chainlink Functions, and coordinates cross-chain settlements via Arbitrum native messaging."
                                            },
                                            { 
                                                name: "ProductFactory", 
                                                addr: "0x29Fc20d0b2bF7db3325da8a7E1Fc422C91773eD8",
                                            ...
                                            { 
                                                ...
                                                addr: "0xeD2a67a8D4d6add0a278841A9E96B92858EBE736",
                                                desc: "The primary settlement currency for the Reflex protocol on Arbitrum Sepolia. Used for policy purchases, liquidity provision, and claim payouts."
                                            },
                                        ].map((c) => (
                                            <div key={c.name} className="flex flex-col p-4 rounded-xl bg-white/5 border border-white/10 hover:border-violet-500/30 transition-all group">
                                                <div className="flex justify-between items-start mb-2">
                                                    ...
                                                    <a href={`https://sepolia.arbiscan.io/address/${c.addr}`} target="_blank" rel="noopener noreferrer" className="opacity-0 group-hover:opacity-100 transition-opacity text-[10px] text-violet-400 flex items-center gap-1">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <p className="text-xs text-slate-500 italic">All pools utilize the ReflexLiquidityPool engine, securing capital via deterministic algorithm-based reserves.</p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {[
                                            { name: "Travel Liquidity Pool", addr: "0x7FafA41d52eFa6Ad03cB51A877602F6CB0CC5431", desc: "Institutional capital backing the Travel risk sector." },
                                            { name: "Agriculture Liquidity Pool", addr: "0xa5C91b1eCB72bCAbc09B4fefd13175eC16ef3e72", desc: "Capital reserve for agricultural productivity hazards." },
                                            { name: "Energy Liquidity Pool", addr: "0x8f3f5a247E97F78DdDEae96A358aC5Cd175bd7b3", desc: "Dedicated liquidity for renewable energy supply risk." },
                                            { name: "Catastrophe Liquidity Pool", addr: "0x60C09F174A9007D9A1E457b95E67738acFdCf1ad", desc: "High-intensity capital for natural disaster protection." },
                                            { name: "Maritime Liquidity Pool", addr: "0x9Cfbc7AA845a5900CFe30F9C8e0cd5f2c36E6d31", desc: "Global trade liquidity backing ocean logistics." },
                                        ].map((c) => (
                                            <div key={c.name} className="flex flex-col p-4 rounded-xl bg-white/5 border border-white/10 hover:border-emerald-500/30 transition-all group">
                                                <div className="flex justify-between items-start mb-2">
                                                    <span className="text-sm text-foreground font-bold">{c.name}</span>
                                                    <a href={`https://sepolia.arbiscan.io/address/${c.addr}`} target="_blank" rel="noopener noreferrer" className="opacity-0 group-hover:opacity-100 transition-opacity text-[10px] text-emerald-400 flex items-center gap-1">
                                                        Arbiscan <span className="material-symbols-outlined text-[12px]">open_in_new</span>
                                                    </a>
                                                </div>
                                                <p className="text-xs text-slate-400 leading-relaxed mb-3">{c.desc}</p>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {[
                                            ...
                                            <div key={c.name} className="flex flex-col p-4 rounded-xl bg-white/5 border border-white/10 hover:border-blue-500/30 transition-all group">
                                                <div className="flex justify-between items-start mb-2">
                                                    <span className="text-sm text-foreground font-bold">{c.name}</span>
                                                    <a href={`https://sepolia.arbiscan.io/address/${c.addr}`} target="_blank" rel="noopener noreferrer" className="opacity-0 group-hover:opacity-100 transition-opacity text-[10px] text-blue-400 flex items-center gap-1">
                                                        Arbiscan <span className="material-symbols-outlined text-[12px]">open_in_new</span>
                                                    </a>
                                                </div>
                                                <p className="text-xs text-slate-400 leading-relaxed mb-3">{c.desc}</p>

...
export default function WhitepaperPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-[#0B0E14] py-12 px-4 sm:px-6 lg:px-8 selection:bg-slate-900 selection:text-[#1A1A1A] dark:selection:bg-white dark:selection:text-slate-900 overflow-y-auto pt-24 pb-24 transition-colors duration-700">
      ...
      <div className="max-w-4xl mx-auto mb-10 flex items-center justify-between print:hidden animate-fade-in-up">
        <Link
          href="/"
          className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-[#1A1A1A] transition-all group"
        >
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 px-6 py-2.5 bg-slate-900 dark:bg-white text-[#1A1A1A] dark:text-slate-900 rounded-lg text-sm font-bold hover:shadow-xl hover:scale-[1.02] transition-all active:scale-95 border-2 border-slate-900 dark:border-white shadow-lg shadow-slate-200 dark:shadow-none"
          >
      ...
      <article className="max-w-[850px] mx-auto bg-white shadow-[0_25px_80px_rgba(0,0,0,0.15)] rounded-sm overflow-hidden print:shadow-none print:rounded-none relative z-10 transition-shadow duration-500 hover:shadow-[0_35px_100px_rgba(0,0,0,0.2)]">
        ...
        <div className="border-b-[4px] border-slate-900 px-16 pt-24 pb-16 flex flex-col items-center text-center">
          ...
          <h1 className="text-[3.25rem] leading-[1.05] font-bold text-slate-900 mb-6 tracking-tighter font-sans uppercase">
            Reflex Protocol: <br/>
        ...
        {/* Document Body */}
        <div className="px-16 py-20 text-slate-800 leading-[1.8] text-base space-y-16 antialiased">
            
            {/* Section 1 */}
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">1. Executive Summary</h2>
                <div className="space-y-6">
                    <p className="first-letter:text-5xl first-letter:font-bold first-letter:float-left first-letter:mr-2 first-letter:mt-1 first-letter:text-slate-900">
            ...
            {/* Section 2 */}
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">2. Introduction</h2>
                <p>
            ...
            {/* Section 3 */}
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">3. Problem Statement</h2>
            ...
            {/* Section 4 */}
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">4. Proposed Solution</h2>
                ...
                <div className="grid grid-cols-1 gap-8 mt-6 font-sans">
                  <div className="p-8 bg-slate-50 rounded-sm border-l-4 border-slate-900">
                    <h3 className="font-bold text-slate-900 mb-3 uppercase tracking-tighter">Zero-Touch Parametric Payouts</h3>
                  ...
                  <div className="p-8 bg-slate-50 rounded-sm border-l-4 border-slate-900">
                    <h3 className="font-bold text-slate-900 mb-3 uppercase tracking-tighter">Deterministic Ring-Fencing</h3>
                  ...
                  <div className="p-8 bg-slate-50 rounded-sm border-l-4 border-slate-900">
                    <h3 className="font-bold text-slate-900 mb-3 uppercase tracking-tighter">API-First "Invisible" Distribution</h3>
            ...
            <section className="space-y-8">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">5. Technical Architecture</h2>
                <div className="space-y-10">
                  <div className="group">
                    <h4 className="font-bold font-sans text-slate-900 mb-2 uppercase tracking-tight text-lg">5.1 Execution Layer: Arbitrum Sepolia</h4>
                  ...
                  <div className="group">
                    <h4 className="font-bold font-sans text-slate-900 mb-2 uppercase tracking-tight text-lg">5.2 Segmented Risk Vaults</h4>
                  ...
                  <div className="group">
                    <h4 className="font-bold font-sans text-slate-900 mb-2 uppercase tracking-tight text-lg">5.3 Oracle Layer: Chainlink Triple-Threat</h4>
            ...
            {/* Section 7 - Roadmap */}
            <section className="space-y-8">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">7. Enterprise Roadmap (Phase 2-4)</h2>
                <div className="space-y-6">
                    <div className="p-6 bg-slate-50 border border-slate-200">
                        <h4 className="font-bold text-slate-900 uppercase text-xs tracking-widest mb-3">Modular SDK Architecture</h4>
                    ...
                    <div className="p-6 bg-slate-50 border border-slate-200">
                        <h4 className="font-bold text-slate-900 uppercase text-xs tracking-widest mb-3">Real-Time Risk Simulation</h4>
            ...
            {/* Section 6 */}
            <section className="space-y-8">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">6. Protocol Economics</h2>
                <p>Reflex operates entirely on USDC, intentionally avoiding the volatility risk associated with native protocol tokens.</p>
                <div className="bg-slate-950 text-white p-12 rounded-sm relative overflow-hidden group">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-1 gap-12 relative z-10 w-1/2">
                      <div>
                        <span className="text-[0.65rem] text-slate-500 uppercase font-bold tracking-wider block mb-2">Origination Fee</span>
                        <div className="flex items-baseline gap-1">
                          <span className="text-5xl font-bold tracking-tighter">2.5 — 5.0</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 gap-8 text-[0.8rem] text-slate-500 font-sans tracking-tight">
             ...
             {/* Use Cases */}
             <section className="space-y-8">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">8. High-Impact Use Cases</h2>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 font-sans">
                  <div className="flex flex-col gap-4">
                    <span className="text-slate-300 font-bold text-4xl">01</span>
                    <h4 className="font-bold text-slate-900 uppercase text-xs tracking-widest leading-none">Aviation Delay</h4>
                  ...
                  <div className="flex flex-col gap-4">
                    <span className="text-slate-300 font-bold text-4xl">02</span>
                    <h4 className="font-bold text-slate-900 uppercase text-xs tracking-widest leading-none">Para-Agriculture</h4>
                  ...
                  <div className="flex flex-col gap-4">
                    <span className="text-slate-300 font-bold text-4xl">03</span>
                    <h4 className="font-bold text-slate-900 uppercase text-xs tracking-widest leading-none">Energy Stability</h4>
            ...
            {/* Security */}
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">10. Security & Capital Safety</h2>
                <p>Protocol integrity is enforced through three core cryptographic layers:</p>
                <div className="space-y-6 font-sans">
                  <div className="flex gap-6">
                    <div className="w-12 h-12 shrink-0 rounded-full bg-slate-900 flex items-center justify-center text-white font-bold">!</div>
                    <div>
                      <h5 className="font-bold text-slate-900 uppercase tracking-tighter text-sm">Enforced Solvency</h5>
                  ...
                  <div className="flex gap-6">
                    <div className="w-12 h-12 shrink-0 rounded-full bg-slate-900 flex items-center justify-center text-white font-bold">S</div>
                    <div>
                      <h5 className="font-bold text-slate-900 uppercase tracking-tighter text-sm">Stateful Hardening</h5>
            ...
            {/* Team */}
            <section className="space-y-6">
                <h2 className="text-2xl font-bold font-sans text-slate-900 uppercase tracking-tighter border-b-2 border-slate-100 pb-2">11. Management & Systems</h2>
                <div className="p-8 border-2 border-slate-900 font-sans relative group">
                  <div className="absolute top-0 right-0 bg-slate-900 text-white px-4 py-1 text-[0.6rem] font-bold uppercase tracking-wider -translate-y-full">Core Architect</div>
                  <h4 className="font-bold text-2xl text-slate-900 uppercase tracking-tighter mb-2 underline decoration-4 decoration-slate-200 underline-offset-8">Uche Ezette</h4>
            ...
            {/* Footer */}
            <div className="pt-16 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center sm:items-end gap-6 text-[0.65rem] text-slate-400 font-sans font-bold uppercase tracking-wider">
      ...
      <div className="mt-20 text-center print:hidden border-t border-slate-200 dark:border-slate-800 pt-16 animate-fade-in pb-12">
          ...
          <p className="text-slate-400 dark:text-slate-600 text-[0.6rem] tracking-wider uppercase font-bold">Powered by Arbitrum Sepolia & Chainlink</p>
      </div>
      ...
      <style jsx global>{`
        ...
        /* Unified font - inherits Inter from layout */
      `}</style>
    </div>
  );
}

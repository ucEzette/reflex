...
export default function ProfilePage() {
    ...
    return (
        <div className="relative min-h-screen py-10 px-6 flex flex-col items-center">
            ...
            <div className="max-w-6xl w-full relative z-10 flex flex-col gap-12">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <h1 className="text-4xl md:text-6xl font-black text-foreground mb-4 tracking-tight">User Profile</h1>
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-2xl font-bold text-foreground tracking-tight">Claim History</h2>
                                </div>
                                <ClaimHistory />
                            </div>
